...
const DAYS = [
  {
    ...
    title: '내 강점 + 타겟 정하기',
    time: '30분',
    desc: 'AI한테 나 분석 시키고, 누구한테 보여줄지 정하기',
  },
  {
    day: 2,
    emoji: '🔍',
...
export default function AI5DayLanding() {
    ...
    <div className="min-h-screen bg-[#c8ff00] scroll-smooth snap-y snap-mandatory overflow-y-auto h-screen">
      ...
      <section className="relative overflow-hidden px-6 py-16 text-center min-h-screen flex flex-col justify-center snap-start" style={{ fontFamily: "'KyoboHandwriting2019', sans-serif" }}>
        ...
        <div className="absolute left-2 md:left-[12%] bottom-8 md:bottom-auto md:top-20 z-20">
          <motion.img
            src={jeongkooActive || clickedChar === 'jeongkoo' ? "/c_c_works/jeongkoo_v2.png" : "/c_c_works/jeongkoo.png"}
            alt="정쿠"
        ...
        <div className="absolute right-2 md:right-[12%] top-16 z-20">
          <motion.img
            src={kjang1Active || clickedChar === 'kjang1' ? "/c_c_works/kjang1_v2.png" : "/c_c_works/kjang1.png"}
            alt="크크웍스1"
            className="w-32 md:w-48 rotate-[8deg] cursor-pointer"
        ...
        <div className="absolute right-2 md:right-[18%] bottom-8 z-20">
          <motion.img
            src={kjang2Active || clickedChar === 'kjang2' ? "/c_c_works/kjang2_v2.png" : "/c_c_works/kjang2.png"}
            alt="크크웍스2"
            className="w-20 md:w-36 rotate-[-3deg] cursor-pointer"
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-black/70 mb-8 mt-0">
            설마.. 아직도 포폴 없이 견적 보내세요?<br/><br/>
      ...
      <section className="bg-black text-white px-6 py-16 min-h-screen flex flex-col justify-center snap-start" style={{ fontFamily: "'KyoboHandwriting2019', sans-serif" }}>
        ...
        >
          <motion.h2
            variants={fadeInUp}
            className="text-3xl md:text-4xl font-black text-[#c8ff00] text-center mb-10"
            style={pointFont}
          >
            이런 분 손 🙋
          </motion.h2>
          ...
          <div className="flex flex-col md:flex-row md:items-stretch gap-0 md:gap-4 ">
            ...
            <motion.div variants={fadeInUp} className="flex-1 bg-white rounded-2xl p-4 md:p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-black">크크웍스</h3>
              </div>
            ...
            <motion.div variants={fadeInUp} className="flex-1 bg-white rounded-2xl p-4 md:p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <span className="text-2xl">🧪</span>
                <h3 className="text-xl font-black">실험마켓</h3>
              </div>
      ...
      <section className="px-6 py-16 bg-black min-h-screen flex flex-col justify-center snap-start" style={{ fontFamily: "'KyoboHandwriting2019', sans-serif" }}>
        ...
        >
          <motion.h2
            variants={fadeInUp}
            className="text-3xl md:text-4xl font-black text-[#c8ff00] text-center mb-4"
            style={pointFont}
          >
            어차피 혼자는 안 함 ㅇㅈ?
          </motion.h2>
      ...
      <section className="px-6 py-16 bg-white min-h-screen flex flex-col justify-center snap-start" style={{ fontFamily: "'KyoboHandwriting2019', sans-serif" }}>
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-center text-gray-500 mb-10">
            매일 30분, 커피 한 잔이면 끝 ☕️
          </motion.p>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="mb-8 grid grid-cols-2 gap-3">
            <div className="bg-black text-white rounded-xl p-4 text-center">
              <p className="text-[#c8ff00] font-black text-lg">3/28 (토)</p>
              <p className="text-sm">Day 1 시작 🚀</p>
            </div>
            <div className="bg-black text-white rounded-xl p-4 text-center">
              <p className="text-[#c8ff00] font-black text-lg">4/3 (금)</p>
              <p className="text-sm">뒷풀이 겸 축하모임 🍻</p>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              {
                title: '큐리 스터디',
                url: 'https://kurie-lab.vercel.app/study',
      ...
      <section id="apply" className="bg-black text-white px-6 py-20 text-center min-h-screen flex flex-col justify-center snap-start" style={{ fontFamily: "'KyoboHandwriting2019', sans-serif" }}>
        ...
        >
          <motion.h2
            variants={fadeInUp}
            className="text-3xl md:text-4xl font-black text-[#c8ff00] mb-4"
            style={pointFont}
          >
            5일 후, 나만의 포트폴리오가 생긴다
          </motion.h2>
